...
# Keep the default local work directory, while allowing isolated integration
# tests and self-hosted instances to point the runtime at an explicit data root.
# The directory is still resolved before any project slug is accepted.
WORK = Path(os.environ.get("GEO_WORK", str(ROOT / "work"))).expanduser().resolve()
